...
#sql connection
mydb = mysql.connector.connect(host="localhost",user="root",password="9391674255",database="phonepay")
cursor = mydb.cursor()
...
def Aggre_insurance_Y(df,year):
    ...
    with col1:
        ...
        fig_amount.update_layout(plot_bgcolor = "pink")
    ...
    with col2:
        ...
        fig_count.update_layout(plot_bgcolor = "gray")
    ...
    with col1:
        ...
        fig_india_1= px.choropleth(aiyg, geojson= data1, locations= "States", featureidkey= "properties.ST_NM",
                                 ...
                                 fitbounds= "locations",width =300, height= 600)
...
def Aggre_insurance_Y_Q(df,quarter):
    ...
    with col1:
        ...
        fig_q_amount.update_layout(plot_bgcolor="lightblue")
    ...
    with col2:
        ...
        fig_q_count.update_layout(plot_bgcolor="black")
...
def map_insure_plot_2(df,state):
    ...
    with col1:
        ...
        fig_map_pie_1.update_layout(plot_bgcolor="black")
...
def ques4():
    ...
    fig_htd= px.pie(htd2, values= "Transaction_amount", names= "Districts", title="TOP 10 DISTRICTS OF LOWEST TRANSACTION AMOUNT",width=700,height=700,
...
def ques6():
    ...
    fig_sa= px.bar(sa2, x= "States", y= "AppOpens", title="lowest 10 States With AppOpens",width=800,height=900,
...
def ques8():
    ...
    fig_stc= px.bar(stc2, x= "States", y= "Transaction_count", title= "STATES WITH HIGHEST TRANSACTION COUNT",width=400,height=500,
...
def ques9():
    ...
    fig_lts= px.bar(ht2, x= "States", y= "Transaction_amount",title= "HIGHEST TRANSACTION AMOUNT and STATES",width=400,height=500,
                    color_discrete_sequence= px.colors.sequential.Oranges_r)
    return st.plotly_chart(fig_lts)
...
def ques10():
    ...
    fig_dt= px.bar(dt2, x= "Districts", y= "Transaction_amount", title= "DISTRICTS WITH LOWEST TRANSACTION AMOUNT",width=1100,height=800,text_auto='.2s',
                color_discrete_sequence= px.colors.sequential.ice_r)
    fig_dt.update_traces(textfont_size=28, textangle=90, textposition="outside",textfont_color='red')
    fig_dt.update_layout(plot_bgcolor='black')
...
if select == "Home":
    ...
    with col2:
        st.video("C:\\Users\\sairam\\Downloads\\Phone pay Ad.mp4")

    col3,col4= st.columns(2)
    
    with col3:
        st.video("C:\\Users\\sairam\\Downloads\\PhonePe Motion Graphics.mp4")
